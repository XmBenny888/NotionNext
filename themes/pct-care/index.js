  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-bold text-center mb-8 text-gray-900 dark:text-white">Latest Articles & News</h2>
        <p className="text-center text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto">
          Stay informed with the latest in caregiving, industry trends, and health advice.
        </p>
